...
int main()
{
    ...
    unsigned int texture2 = create_texture("assets/textures/awesomeface.png", GL_REPEAT, GL_LINEAR, GL_RGBA);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //positioning the object in the world
